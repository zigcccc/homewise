 ...
 * Typing is allowed for fast entry; the calendar covers the "which day was that?" case. Shared with
 * the profile General tab (date of birth) — both dates can only be in the past.
 */
