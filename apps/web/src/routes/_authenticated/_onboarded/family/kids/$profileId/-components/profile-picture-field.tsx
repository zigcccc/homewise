...
/**
 * The avatars this client offers. The client owns the set — the server never lists or bundles them;
 * it only stores whichever one the user picks. Each name maps to `public/avatars/<name>.svg`.
 */
const AVATARS = [
  'kid-male-baby',
  'kid-male-toddler',
  ...
  'kid-female-baby',
  'kid-female-toddler',
  'kid-female-preschool',
  'kid-female-teenage',
] as const;

const avatarSrc = (name: string) => `/avatars/${name}.svg`;
...
/**
 * The child's profile picture, editable via a dialog: upload a photo or pick one of the bundled
