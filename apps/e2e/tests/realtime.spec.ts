...
test.describe('realtime', () => {
   ...
   */
  test('shows another member’s changes on an open page, without a reload', async ({ browser, household, page }) => {
   ...
   */
  test('shows a meal another member plans, without a reload', async ({ browser, household, page }) => {
    test.slow();
   ...
   */
  test('shows an item another member ticks off, without a reload', async ({ browser, household, page }) => {
    test.slow();
   ...
   */
  test('shows another member’s change arriving in the activity feed, without a reload', async ({
    browser,
    household,
    page,
  }) => {
