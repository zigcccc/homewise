...
/**
 * The look of a closed select: label on the left, chevron pinned right, muted when it's a placeholder.
 *
 * Exported because `ComboboxFieldTrigger` wears it too — a combobox *is* a searchable select, so the
 * two staying identical should be a matter of construction rather than of someone remembering.
 */
